...
$oldSetArray_b993e195436bb1c7455e1d8947d07351 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
  ';
$oldRestoreIncludeArray_5aec22fa3307f1cc3cd45a7ea1e0d021 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style_inline-ff3705779e4b3bc7d9588d1fdcd09f5a.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style_inline-ff3705779e4b3bc7d9588d1fdcd09f5a.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_5aec22fa3307f1cc3cd45a7ea1e0d021;
...
$setArray = $oldSetArray_b993e195436bb1c7455e1d8947d07351;
$tpl->Level--;
?>

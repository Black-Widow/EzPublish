...
$oldSetArray_7e5921b293896274a03807b228611d10 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/Lab/eZ/ezpublish_legacy/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" border="0" alt="Modifier" />
                </a>
            </td>
        </tr>
    ';
...
$setArray = $oldSetArray_7e5921b293896274a03807b228611d10;
$tpl->Level--;
?>

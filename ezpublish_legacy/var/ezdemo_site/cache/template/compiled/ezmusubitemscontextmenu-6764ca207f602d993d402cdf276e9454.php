...
$oldSetArray_bad6046ca62881b1c48be1082cc4b252 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-multiupload\'][\'url\'] = "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/ezmultiupload/upload/%nodeID%";
</script>

<a id="child-menu-multiupload" href="#" onmouseover="ezpopmenu_mouseOver( \'ContextMenu\' )" >Envoyer plusieurs fichiers</a>
';

$setArray = $oldSetArray_bad6046ca62881b1c48be1082cc4b252;
$tpl->Level--;
?>

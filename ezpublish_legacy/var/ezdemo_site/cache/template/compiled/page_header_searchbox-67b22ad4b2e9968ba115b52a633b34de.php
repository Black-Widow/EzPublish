...
$oldSetArray_d06390f0ec36dd9dd90152d332668f97 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<form class="span4 form-search" method="get" action="/Lab/eZ/ezpublish_legacy/index.php/fre/content/search" id="site-wide-search">
...
$setArray = $oldSetArray_d06390f0ec36dd9dd90152d332668f97;
$tpl->Level--;
?>

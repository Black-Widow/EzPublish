...
$oldSetArray_ead3c4043cb02c59691ab5e9f7202e05 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<link rel="stylesheet" type="text/css" href="/Lab/eZ/ezpublish_legacy/" />';
}
unset( $if_cond );
// if ends
...
$text .= '<link rel="stylesheet" type="text/css" href="/Lab/eZ/ezpublish_legacy/extension/ezdemo/design/ezdemo/stylesheets/print.css" media="print" />
';

$setArray = $oldSetArray_ead3c4043cb02c59691ab5e9f7202e05;
$tpl->Level--;
?>

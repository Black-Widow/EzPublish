...
// Timestamp: 1400148138 (Thu May 15 12:02:18 CEST 2014)
$oldSetArray_12c6079c9bfa872f7dd3177459fb9e02 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-child-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'edit-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/edit/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'delete-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/delete/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'merge-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/merge/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-synonym-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/addsynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'make-synonym-tag\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/makesynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '    menuArray[\'TagMenuSimple\'] = { \'depth\': 0, \'headerID\': \'tag-simple-header\' };
    ...
    menuArray[\'TagMenuSimple\'][\'elements\'][\'add-child-tag-simple\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_12c6079c9bfa872f7dd3177459fb9e02;
$tpl->Level--;
?>

...
$oldSetArray_fc89c6f17cec1098969e99f3f4bfc289 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '            <p class="advanced hide"><a href="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/advancedsearch" title="Recherche avancée.">Avancé</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_fc89c6f17cec1098969e99f3f4bfc289;
$tpl->Level--;
?>

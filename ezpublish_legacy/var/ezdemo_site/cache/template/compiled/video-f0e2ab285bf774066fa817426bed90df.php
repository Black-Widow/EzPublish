...
$oldSetArray_893a9e332364f4509a81a5e272d29848 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<script>
    _V_.options.flash.swf = "/Lab/eZ/ezpublish_legacy/extension/ezdemo/design/ezdemo/flash/video-js.swf"
</script>
...
$setArray = $oldSetArray_893a9e332364f4509a81a5e272d29848;
$tpl->Level--;
?>

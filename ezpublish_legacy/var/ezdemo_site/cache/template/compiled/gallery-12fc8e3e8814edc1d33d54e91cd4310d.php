...
$oldSetArray_3d0f46f0c4f790a442fb399d5a47adf5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-32768fea3197cb664934373306992a34.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-32768fea3197cb664934373306992a34.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_viewer-b620f82b9a1a429936a8bc6a96070e48.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_viewer-b620f82b9a1a429936a8bc6a96070e48.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$text .= '        </div>
        <div class="gallery-navigator">
            ...
            <img src="/Lab/eZ/ezpublish_legacy/extension/ezdemo/design/ezdemo/images/fg-selected.png" alt="Selected indicator" class="cursor" />
            <ul class="images">
            ';
// foreach begins
$skipDelimiter = true;
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-2871010d6b83725db09d207dc919d667.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-2871010d6b83725db09d207dc919d667.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_item-571405c720f4f16825349655df76698b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_item-571405c720f4f16825349655df76698b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$setArray = $oldSetArray_3d0f46f0c4f790a442fb399d5a47adf5;
$tpl->Level--;
?>

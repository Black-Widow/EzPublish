...
$oldSetArray_3a7070461567ae1bd7d3ec2653b62d02 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'ContextMenu\'][\'elements\'][\'menu-view\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/view/full/%nodeID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-edit\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/edit/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy\'] = { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/copy/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy-subtree\']= { \'url\': "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_3a7070461567ae1bd7d3ec2653b62d02;
$tpl->Level--;
?>

...
$oldSetArray_d0d490f1ce899611ab19b801836557c1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/Lab/eZ/ezpublish_legacy/index.php/fre" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Index" href="/Lab/eZ/ezpublish_legacy/index.php/fre" />
<link rel="Top"  href="/Lab/eZ/ezpublish_legacy/index.php/fre" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/Lab/eZ/ezpublish_legacy/index.php/fre/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Copyright" href="/Lab/eZ/ezpublish_legacy/index.php/fre/ezinfo/copyright" />
<link rel="Author" href="/Lab/eZ/ezpublish_legacy/index.php/fre/ezinfo/about" />
<link rel="Alternate" type="application/rss+xml" title="RSS" href="/Lab/eZ/ezpublish_legacy/index.php/fre/rss/feed/my_feed" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_d0d490f1ce899611ab19b801836557c1;
$tpl->Level--;
?>

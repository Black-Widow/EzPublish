...
$oldSetArray_2e0ef5eee0a6189f05b11c7dd816f787 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    ';
$oldRestoreIncludeArray_b15c56b41eeaf3029aee872e530728f8 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-2811d71744c75d75749876aceea807d8.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-2811d71744c75d75749876aceea807d8.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_b15c56b41eeaf3029aee872e530728f8;
...
{
$text .= '    ';
$oldRestoreIncludeArray_dc603de5f1444f1503f7d8c7c3740ccb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-16f42d9683452dbdcece3806e0163440.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-16f42d9683452dbdcece3806e0163440.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_dc603de5f1444f1503f7d8c7c3740ccb;
...
$setArray = $oldSetArray_2e0ef5eee0a6189f05b11c7dd816f787;
$tpl->Level--;
?>

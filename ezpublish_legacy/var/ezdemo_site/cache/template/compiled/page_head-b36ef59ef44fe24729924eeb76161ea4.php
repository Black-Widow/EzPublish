...
$oldSetArray_94b762af2806b30e833519f77d481639 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    ';
$oldRestoreIncludeArray_b8b334bcb7ac8b82ac60d59de6f957e9 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-5a0e969a38fa7f613aeeccb0b9864a5e.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-5a0e969a38fa7f613aeeccb0b9864a5e.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_b8b334bcb7ac8b82ac60d59de6f957e9;
...
{
$text .= '    ';
$oldRestoreIncludeArray_b034dd33525789521b028a44b61774fd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-2af18a93d854a7b923ca912c32a739cb.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-2af18a93d854a7b923ca912c32a739cb.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b034dd33525789521b028a44b61774fd;
...
$setArray = $oldSetArray_94b762af2806b30e833519f77d481639;
$tpl->Level--;
?>

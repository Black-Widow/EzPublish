...
$oldSetArray_2cf1f8c376e94d79fde8f55ecb823af7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "3_0_3_36_design/standard/templates/dashboard/all_latest_content.tpl", "ezdemo_site_admin" );
...
$text .= '">
                    <img src="/Lab/eZ/ezpublish_legacy/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="Modifier" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
{
$text .= '                <img src="/Lab/eZ/ezpublish_legacy/design/standard/images/edit-disabled.gif" alt="Modifier" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_2cf1f8c376e94d79fde8f55ecb823af7;
$tpl->Level--;
?>

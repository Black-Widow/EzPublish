...
$oldSetArray_92fddc1b1e86e4e22abc956df3035e43 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var = strtr( ' <a href="%ezpublish_link">eZ Publish</a> Copyright &copy; 1999-2014 <a href="%ez_link">eZ Systems AS</a> et autres.', $var3 );
...
$var = strtr( 'Pour plus d\'informations veuillez consulter <a href=%about_link>ezinfo/about</a>', $var3 );
...
$setArray = $oldSetArray_92fddc1b1e86e4e22abc956df3035e43;
$tpl->Level--;
?>

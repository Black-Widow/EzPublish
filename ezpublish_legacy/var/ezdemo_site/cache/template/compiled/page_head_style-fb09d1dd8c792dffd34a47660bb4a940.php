...
$oldSetArray_e8100ac200aa4879358ee2f655afbaf9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
  ';
$oldRestoreIncludeArray_c6d937dff757db4bfcaf83fcdd0a31af = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style_inline-b47dc5763ada14686af2576b8a2cd691.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style_inline-b47dc5763ada14686af2576b8a2cd691.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_c6d937dff757db4bfcaf83fcdd0a31af;
...
$setArray = $oldSetArray_e8100ac200aa4879358ee2f655afbaf9;
$tpl->Level--;
?>

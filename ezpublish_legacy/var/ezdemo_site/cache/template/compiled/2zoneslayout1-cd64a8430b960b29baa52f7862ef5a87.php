...
$oldSetArray_eeeda08635a1db771a67b6462d9de733 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '                ';
$oldRestoreIncludeArray_2148a5f2c3525b655e6b2bfaf61d7ba1 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/zone_block-faca51408fe31c7e71972bea9cc64d3c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/zone_block-faca51408fe31c7e71972bea9cc64d3c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2148a5f2c3525b655e6b2bfaf61d7ba1;
...
$text .= '                    ';
$oldRestoreIncludeArray_57b1af6f74125d17e4b5f40f52dd81ab = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_57b1af6f74125d17e4b5f40f52dd81ab;
...
$setArray = $oldSetArray_eeeda08635a1db771a67b6462d9de733;
$tpl->Level--;
?>

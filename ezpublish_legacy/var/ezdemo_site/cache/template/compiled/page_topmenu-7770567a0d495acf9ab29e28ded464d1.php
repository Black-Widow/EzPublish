...
$oldSetArray_b859b272377844bc5ae92fecb1c876ac = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '    ';
$oldRestoreIncludeArray_313169863055fbc1079ee19ab0a13285 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenuitem-626cbcbdc4cb37b327ffae9dcc7c4075.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenuitem-626cbcbdc4cb37b327ffae9dcc7c4075.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_313169863055fbc1079ee19ab0a13285;
...
$setArray = $oldSetArray_b859b272377844bc5ae92fecb1c876ac;
$tpl->Level--;
?>

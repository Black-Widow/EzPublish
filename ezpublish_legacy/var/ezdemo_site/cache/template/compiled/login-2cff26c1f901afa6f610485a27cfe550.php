...
$oldSetArray_d189ae4ba6cda4820acc4857d3d61d5e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="loginform" method="post" action="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/user/login">
...
{
$text .= '        <div class="block login-text-wrapper">
            <input type="checkbox" name="Cookie" id="id3" /><label for="id3" style="display:inline;">Me rappeler</label>
        </div>
    ';
}
unset( $if_cond );
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        ou
        <br/>
        <a href="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/user/register">Créer un nouveau compte</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_d189ae4ba6cda4820acc4857d3d61d5e;
$tpl->Level--;
?>

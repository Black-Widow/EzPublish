...
$oldSetArray_dbe83cc290aefbf5fee8b485197b6c08 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div class="box-header">
    ';
$oldRestoreIncludeArray_4591b92f69b958dc70226055337a2e13 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/maintenance-8c5d6320c07718fe9318ee47922e7f22.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/maintenance-8c5d6320c07718fe9318ee47922e7f22.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_4591b92f69b958dc70226055337a2e13;
...
$setArray = $oldSetArray_dbe83cc290aefbf5fee8b485197b6c08;
$tpl->Level--;
?>

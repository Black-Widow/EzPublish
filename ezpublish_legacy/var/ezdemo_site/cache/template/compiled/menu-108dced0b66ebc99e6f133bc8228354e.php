...
$oldSetArray_dbeda0d131b974aa689e3a18a9fabcb9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$oldRestoreIncludeArray_aed1bc276b2d15622371ae2271eecdb7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/ini_menu-1ddcbd8127d354deaac53f985571d9a3.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/ini_menu-1ddcbd8127d354deaac53f985571d9a3.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_aed1bc276b2d15622371ae2271eecdb7;
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_e5fc05d856ecc4ed986a62d153b98649 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-5b72a6326d7ea015b55873be6a348720.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-5b72a6326d7ea015b55873be6a348720.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e5fc05d856ecc4ed986a62d153b98649;
...
$setArray = $oldSetArray_dbeda0d131b974aa689e3a18a9fabcb9;
$tpl->Level--;
?>

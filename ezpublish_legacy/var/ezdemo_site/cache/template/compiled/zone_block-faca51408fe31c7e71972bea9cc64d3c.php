...
$oldSetArray_edd88e8becb23e92d914f0ddc91975d4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$oldRestoreIncludeArray_94bb98c5e3ebdc8df4e41b423353a829 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/zone_block_top-354453919cfce71dfdb8c4d3c3d6a03e.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/zone_block_top-354453919cfce71dfdb8c4d3c3d6a03e.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_94bb98c5e3ebdc8df4e41b423353a829;
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/campaign-ab8ea9985223e9c224876577757e29dd.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/campaign-ab8ea9985223e9c224876577757e29dd.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/main_story_highlighted-42075f0853b53567af4ea9899dddbd9c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/main_story_highlighted-42075f0853b53567af4ea9899dddbd9c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/main_story_background_image-5d52cf3006bb29fdf56b4366b878b473.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/main_story_background_image-5d52cf3006bb29fdf56b4366b878b473.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_1col_2rows-f356feac09c3c1916c3a0f1b5b2ea2d4.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_1col_2rows-f356feac09c3c1916c3a0f1b5b2ea2d4.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_1col_4rows-14fce9ff4e2764269a1e825d5c510f0f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_1col_4rows-14fce9ff4e2764269a1e825d5c510f0f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_2cols_2rows-2fbc96124286daea7c3ef16950193add.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_2cols_2rows-2fbc96124286daea7c3ef16950193add.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_3cols_1row-6b5b2818e6dc671dc06bc3afac553211.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_3cols_1row-6b5b2818e6dc671dc06bc3afac553211.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_3cols_2rows-5b962b035d8ef0b850f73d100d16e077.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_3cols_2rows-5b962b035d8ef0b850f73d100d16e077.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_4cols_1row-7d32ddcf69337245664473183a7fd091.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_4cols_1row-7d32ddcf69337245664473183a7fd091.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_grid_4cols_2rows-3d0531151bffd7347436f4e4c0089f19.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_grid_4cols_2rows-3d0531151bffd7347436f4e4c0089f19.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery-12fc8e3e8814edc1d33d54e91cd4310d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery-12fc8e3e8814edc1d33d54e91cd4310d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/banner_internal-3afb9de9e5eb9b198846234a1c12b8b2.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/banner_internal-3afb9de9e5eb9b198846234a1c12b8b2.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/banner_external-3cc397c31f51576d6ebe105f0d6bd044.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/banner_external-3cc397c31f51576d6ebe105f0d6bd044.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/banner_code-9a1ba7a55e24c127deee1bad3e2054ad.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/banner_code-9a1ba7a55e24c127deee1bad3e2054ad.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-f0e2ab285bf774066fa817426bed90df.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-f0e2ab285bf774066fa817426bed90df.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/tag_cloud-8227445655d79bf39d94be55b6827b6a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/tag_cloud-8227445655d79bf39d94be55b6827b6a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/poll-459843b2ecb29195c6f2a35f107a59b2.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/poll-459843b2ecb29195c6f2a35f107a59b2.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/item_list-b313d4b3dc0ae4f8e3680041627a534b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/item_list-b313d4b3dc0ae4f8e3680041627a534b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/feed_reader-54a3931a65b01ab94f9b9de0bad64ef1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/feed_reader-54a3931a65b01ab94f9b9de0bad64ef1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/feedback_form-c68c9862ca03bd485315e512e729074c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/feedback_form-c68c9862ca03bd485315e512e729074c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/highlighted_item-71a8e94309d5ce374aa993003dc6c218.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/highlighted_item-71a8e94309d5ce374aa993003dc6c218.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/view-71f9b5ee09f874e33ba8254c7f2437d9.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentAttributeBlockView' : ( $currentNamespace . ':' . 'ContentAttributeBlockView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/view-71f9b5ee09f874e33ba8254c7f2437d9.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$oldRestoreIncludeArray_89513fb0a0544b78bfe109039fbc0ebd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/zone_block_bottom-5b4b0134577e834f5854508def025026.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/zone_block_bottom-5b4b0134577e834f5854508def025026.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_89513fb0a0544b78bfe109039fbc0ebd;


$setArray = $oldSetArray_edd88e8becb23e92d914f0ddc91975d4;
$tpl->Level--;
?>

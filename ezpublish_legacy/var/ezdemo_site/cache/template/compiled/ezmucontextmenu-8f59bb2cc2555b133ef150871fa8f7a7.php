...
$oldSetArray_1224467401af3285a4f775c887a10c47 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'ContextMenu\'][\'elements\'][\'menu-multiupload\'][\'url\'] = "/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/ezmultiupload/upload/%nodeID%";
</script>

<a id="menu-multiupload" href="#" onmouseover="ezpopmenu_mouseOver( \'ContextMenu\' )" >Envoyer plusieurs fichiers</a>';

$setArray = $oldSetArray_1224467401af3285a4f775c887a10c47;
$tpl->Level--;
?>

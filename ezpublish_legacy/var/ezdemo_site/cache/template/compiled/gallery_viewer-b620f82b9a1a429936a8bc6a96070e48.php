<?php
// URI:       extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl
// Filename:  extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl
// Timestamp: 1485119710 (Sun Jan 22 22:15:10 CET 2017)
$oldSetArray_775121eb92303a4a422b8e8c7aeda4b3 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'image', $rootNamespace ) )
{
  ...
  2 => 'extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl',
) );
...
$text .= '<figure class="gallery-viewer-image';
// if begins
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'is_hidden', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['is_hidden'] : null;
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'total_items', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['total_items'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$text .= ( is_object( $var ) ? compiledFetchText( $tpl, $rootNamespace, $currentNamespace, false, $var ) : $var );
...
$setArray = $oldSetArray_775121eb92303a4a422b8e8c7aeda4b3;
$tpl->Level--;
?>

...
$oldSetArray_a23ab24e11c7a4fa262d788767c1f849 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
';
$oldRestoreIncludeArray_c65aae2d50d0e6a21cf6ef9bab3077de = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-d9aef2ee086b4337a9eadc3f5e124007.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-d9aef2ee086b4337a9eadc3f5e124007.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_c65aae2d50d0e6a21cf6ef9bab3077de;

$text .= '
';
$oldRestoreIncludeArray_a30be43ef5ea766e5af04ee5e2894c08 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-6bf01188f2f325f868746aa32e68fd0b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-6bf01188f2f325f868746aa32e68fd0b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_a30be43ef5ea766e5af04ee5e2894c08;

$oldRestoreIncludeArray_306de0b5d643daf7e11618b80459f1d5 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-0d0d135709568e42e9a2756f246d1f8e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-0d0d135709568e42e9a2756f246d1f8e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_306de0b5d643daf7e11618b80459f1d5;
...
';
$oldRestoreIncludeArray_e007956b0ceadb49da0a88360d279215 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-9a78545a7b3cfc04d7ae7ae83037cde7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-9a78545a7b3cfc04d7ae7ae83037cde7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e007956b0ceadb49da0a88360d279215;
...
';
$oldRestoreIncludeArray_13c477147b54147b12b83a50d720c182 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_login_copyright-7631642d4507a88a15a6a484e61cbdfd.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_login_copyright-7631642d4507a88a15a6a484e61cbdfd.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_13c477147b54147b12b83a50d720c182;
...
$setArray = $oldSetArray_a23ab24e11c7a4fa262d788767c1f849;
$tpl->Level--;
?>

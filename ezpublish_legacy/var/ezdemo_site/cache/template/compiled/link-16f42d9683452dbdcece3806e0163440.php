...
$oldSetArray_473a8970b289592ae88b8cab7360a891 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Top"  href="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/Lab/eZ/ezpublish_legacy/index.php/ezdemo_site_admin/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_473a8970b289592ae88b8cab7360a891;
$tpl->Level--;
?>
